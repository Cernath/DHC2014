...
class GlobalsControllerTest < ActionController::TestCase
  ...
  test "should create global" do
    assert_difference('Global.count') do
      post :create, global: { date: @global.date, departement: @global.departement, maladie: @global.maladie, pays: @global.pays, region: @global.region, ville: @global.ville }
    end
  ...
  test "should update global" do
    patch :update, id: @global, global: { date: @global.date, departement: @global.departement, maladie: @global.maladie, pays: @global.pays, region: @global.region, ville: @global.ville }
    assert_redirected_to global_path(assigns(:global))
  end
